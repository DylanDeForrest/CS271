...
int quartile(char* name) {
  char firstLetter[2] = {name[0], '\0'};
  
  if (strcmp(firstLetter, "A") >= 0 && strcmp(firstLetter, "F") <= 0) {
        return 1;
    } else if (strcmp(firstLetter, "G") >= 0 && strcmp(firstLetter, "L") <= 0) {
        return 2;
    } else if (strcmp(firstLetter, "M") >= 0 && strcmp(firstLetter, "R") <= 0) {
        return 3;
    } else if (strcmp(firstLetter, "S") >= 0 && strcmp(firstLetter, "Z") <= 0) {
        return 4;
    }
}
